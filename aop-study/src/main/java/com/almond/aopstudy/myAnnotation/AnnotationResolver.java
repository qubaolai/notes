...
/**
 * 该类的作用可以把方法上的参数绑定到注解的变量中,注解的语法#{变量名} 能解析类似#{task}或者#{task.taskName}或者{task.project.projectName}
 *
 * @author liuxg
    ...
    private Object getValue(Object obj, int index, String[] strs) {
        ...
        try {
            if (obj != null && index < strs.length - 1) {
                Method method =
                        obj.getClass().getDeclaredMethod(getMethodName(strs[index + 1]), null);
